...
export const RESEARCH_TEMPLATE: LatexDocument = {
  id: 'research',
  title: 'Academic Research Paper',
  subtitle: 'An IEEE-Style Research Publication Template',
  authors: [
    {
      id: 'auth_r1',
      name: 'Dr. Jane Doe',
    ...
    },
    {
      ...
      email: 'jsmith@ai-lab.org',
    },
  ],
  date: 'August 14, 2026',
  abstract: 'This paper presents a comprehensive study on modern LaTeX document generation engines and browser-based WYSIWYG editing workflows. We evaluate compilation speeds, formatting accuracy, and user experience.',
  keywords: ['LaTeX', 'Web Editing', 'Document Generation', 'Typography'],
  sections: [
    {
      id: 'sec_r1',
      title: 'Introduction',
      subsections: [
        {
          ...
          body: 'LaTeX is the de facto standard for the communication and publication of scientific documents. While powerful, traditional workflows often lack real-time visual preview and collaborative editing capabilities.',
        },
      ],
    },
    {
      ...
      subsections: [
        {
          ...
          title: 'Architecture',
          contentType: 'paragraph',
          body: 'Our proposed system integrates a live LaTeX AST compiler with a React-based form editor and KaTeX rendering engine.',
        },
      ],
    },
  ],
...
export const RESUME_TEMPLATE: LatexDocument = {
  id: 'resume',
      ...
      subsections: [
        {
          ...
          title: '',
          contentType: 'paragraph',
          body: 'Results-driven Senior Software Engineer with over 8 years of experience building scalable web applications, distributed backend services, and high-performance user interfaces.',
        },
      ],
    },
    {
      ...
      subsections: [
        {
          id: 'sub_cv2_1',
          title: 'Lead Engineer - TechCorp Inc.',
          contentType: 'paragraph',
          body: 'Led a team of 6 engineers in migrating legacy monolith services to a modern cloud-native microservices architecture, reducing latency by 45%.',
        },
      ],
    },
  ],
...
export const REPORT_TEMPLATE: LatexDocument = {
  id: 'report',
  title: 'Executive Business Report',
  subtitle: 'Q3 Financial & Operational Analysis',
  authors: [
    {
      id: 'auth_rep1',
      name: 'Strategy & Operations Division',
      affiliation: 'Global Enterprises Corp',
      email: 'strategy@globalcorp.com',
    },
  ],
  date: 'August 14, 2026',
  abstract: 'An executive overview of quarterly performance metrics, supply chain optimization, and upcoming civil infrastructure expansion projects.',
  keywords: ['Business Report', 'Q3', 'Operations'],
  sections: [
    {
      id: 'sec_rep1',
      ...
      subsections: [
        {
          ...
          title: 'Overview',
          contentType: 'paragraph',
          body: 'During Q3, operational efficiency increased by 18% across all active project sites. Civil labour contracts were successfully streamlined.',
        },
      ],
    },
  ],
